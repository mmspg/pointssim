function polymodel = polyfitn_c(indepvar,depvar,modelterms)
% % Script retreived from:
% % 	"John D'Errico (2020). polyfitn 
% % 	(https://www.mathworks.com/matlabcentral/fileexchange/34765-polyfitn), 
% %     MATLAB Central File Exchange"
% % Note that some parts of the code are commented, as they are considered 
% % less relevant to our scope while slowing down the execution of the 
% % script. This is why the original function was renamed. The rest of the
...
% % if sum(isnan(t)) >= 1 || sum(isinf(t)) >= 1 || sum(t) == 0
% %     polymodel.p = [];
% % else
